                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <select class="text-sm border rounded px-3 py-1 focus:outline-none focus:ring-2 focus:ring-purple-500">
                                <option>Today</option>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b">
                                        ...
                                        <th class="text-left py-3 px-4 font-medium text-gray-600">Team Lead - Design</th>
                                        <th class="text-left py-3 px-4 font-medium text-gray-600">Office</th>
                                        <th class="text-left py-3 px-4 font-medium text-gray-600">Check In Time</th>
                                ...
                                <tbody>
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                        ...
                                        <td class="py-3 px-4">
                                            <span class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">On Time</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="https://images.unsplash.com/photo-1463453091185-61582044d556?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Employee" class="w-8 h-8 rounded-full">
                                        ...
                                        <td class="py-3 px-4">
                                            <span class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">Late</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm">
                        ...
                        <div class="grid grid-cols-7 gap-1 mb-4">
                            ...
                            <!-- Calendar days -->
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">1</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">2</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">3</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">4</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">5</div>
                            <div class="text-center py-2 text-sm font-medium text-white bg-purple-600 rounded cursor-pointer">6</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">7</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">8</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">9</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">10</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">11</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">12</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">13</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">14</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">15</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">16</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">17</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">18</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">19</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">20</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">21</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">22</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">23</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">24</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">25</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">26</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">27</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">28</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">29</div>
                            <div class="text-center py-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-100 rounded">30</div>
                        </div>
                    </div>
