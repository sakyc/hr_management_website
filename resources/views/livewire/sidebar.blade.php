            ...
            <div class="px-3">
                ...
                <a href="#" class="flex items-center px-3 py-2 text-gray-600 hover:bg-gray-50 rounded-lg mb-1">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <path fill-rule="evenodd" d="M4 5a2 2 0 012-2v1a1 1 0 002 0V3a2 2 0 012 2v6.5A1.5 1.5 0 009.5 13h-3A1.5 1.5 0 005 11.5V5zm1.5 2.5a.5.5 0 01.5-.5h3a.5.5 0 01.5.5v1a.5.5 0 01-.5.5H6a.5.5 0 01-.5-.5v-1zm0 3a.5.5 0 01.5-.5h3a.5.5 0 01.5.5v1a.5.5 0 01-.5.5H6a.5.5 0 01-.5-.5v-1z" clip-rule="evenodd"></path>
                    </svg>
                    Leaves
                </a>
        ...
        <div class="fixed bottom-6 left-6">
                <button class="flex items-center space-x-2 bg-white shadow-lg rounded-full px-4 py-2 hover:shadow-xl transition-shadow">
                    ...
                    <div class="w-6 h-3 bg-gray-200 rounded-full relative">
                        <div class="w-3 h-3 bg-white rounded-full absolute top-0 shadow-sm" x-bind:class="darkMode ? 'right-0' : 'left-0'"></div>
                    </div>
